...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_split_3x5_3(
        KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,  KC_KB_MUTE,        KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,
        KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,  KC_HOME,           KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
                 KC_LBRC, KC_RBRC,                                                      KC_RALT, KC_RCTL,
                            RAISE,   KC_SPC,  KC_TAB,              KC_LCTL, KC_ENT, LOWER
        ),
    [_RAISE] = LAYOUT_split_3x5_3(
        KC_1,    KC_2,    KC_3,    KC_4,    KC_5,  KC_KB_MUTE,        KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
        S(KC_9), S(KC_0), KC_LCBR, KC_RCBR, KC_EQL,                   KC_MINS, KC_4,    KC_5,    KC_6,    KC_QUOT,
        QK_RBT,  _______, KC_LBRC, KC_RBRC,_______,KC_HOME,           _______, KC_1,    KC_2,    KC_3,    _______,
                 QK_BOOT, _______,                                                      _______, _______,
                             _______,   _______,  _______,        _______, _______, _______
        ),

    [_LOWER] = LAYOUT_split_3x5_3(
        KC_EXLM, KC_AT, KC_HASH,  KC_DLR, KC_PERC,   KC_KB_MUTE,      KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,
        S(KC_9), S(KC_0), KC_LBRC,  KC_RBRC,KC_EQL,                   _______,    KC_MINS, KC_EQL,  KC_PIPE, WYLD_AUTO_MS_TOG,
        _______, _______, _______,  SNIPING,DRGSCRL, KC_HOME,         _______,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
