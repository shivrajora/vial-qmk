...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x6_whole(
        ...
        KC_LCTL,KC_LALT,KC_LWIN,KC_LBRC,KC_RBRC,RAISE,                 LOWER,KC_PLUS,KC_BSLASH,KC_RWIN,KC_RALT,KC_RCTL,
                                  KC_SPC, KC_BSPC, KC_GRV,      KC_END, KC_DEL, KC_ENT
        ),
    ...
    [_RAISE] = LAYOUT_5x6_whole(
        ...
        _______,_______,_______,_______,_______,_______,                   _______,_______,SNIPING,DRGSCRL,KC_EQL,_______,
                                         _______,_______,QK_BOOT,          KC_BTN1,KC_BTN3,KC_BTN2
        )
};
