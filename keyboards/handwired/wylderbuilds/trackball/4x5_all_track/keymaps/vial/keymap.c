...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_4x5(
            ...
            _______, _______,_______, _______, _______,               KC_P0,   KC_P1 , KC_P2 , KC_P3 ,KC_EQL ,
    ...
    [_RAISE] = LAYOUT_4x5(
            ...
            WYLD_AUTO_MS_TOG,_______,_______,_______,_______,           _______,_______,_______,_______,_______,
                             _______,_______,                                           _______,_______,
                                        _______,_______,             _______,
                                        _______,_______,             _______,
