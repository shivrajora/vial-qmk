...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_6x7(
        ...
        KC_BTN3, KC_CAPS , KC_A   , KC_S  , KC_D  , KC_F  , KC_G  , KC_MUTE,                KC_H  , KC_J   , KC_K   , KC_L  ,KC_SCLN, KC_LSFT  , DRGSCRL,
        KC_BTN1, KC_LSFT , KC_Z   , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M   , KC_COMM, KC_DOT,KC_SLSH, KC_RSFT  , KC_BTN1,
        KC_LCTL, KC_LGUI, KC_LALT , KC_LBRC,KC_RBRC,                                                         KC_PLUS, KC_EQL,KC_RALT, KC_RGUI  , KC_RCTL,
