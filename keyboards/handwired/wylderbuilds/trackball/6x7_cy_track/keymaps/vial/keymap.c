...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_manuform_6x7(
        ...
        KC_BTN1, KC_CAPS , KC_A   , KC_S  , KC_D  , KC_F  , KC_G  ,                    KC_H  , KC_J   , KC_K   , KC_L  ,KC_SCLN, KC_RCTL,  _______,
    ...
    [_LOWER] = LAYOUT_manuform_6x7(
        ...
        _______,_______,KC_LEFT,KC_UP,KC_DOWN,KC_RGHT,KC_LPRN,                          KC_RPRN,KC_MPRV,KC_MPLY,KC_MNXT,_______,KC_VOLU,QK_BOOT,
    ...
    [_RAISE] = LAYOUT_manuform_6x7(
        ...
        QK_BOOT,_______,KC_HOME,KC_PGUP,KC_PGDN,KC_END ,KC_LPRN,                        KC_RPRN, KC_P4 , KC_P5 , KC_P6 ,KC_MINS,KC_PIPE,_______,
    ...
    [_MOUSE] = LAYOUT_manuform_6x7(
        _______, _______, _______, _______, _______, _______, _______,                           _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______,                           _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______,                           _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, KC_BTN3, KC_BTN2, KC_BTN1, _______,                           _______, KC_BTN1, KC_BTN2, KC_BTN3, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______,                           _______, _______, _______, _______, _______, _______, _______,
                                   _______, _______,                                                               _______, _______,
                                                   _______, KC_BTN1,                          _______,
                                                      KC_BTN3, KC_BTN2,                       _______,
