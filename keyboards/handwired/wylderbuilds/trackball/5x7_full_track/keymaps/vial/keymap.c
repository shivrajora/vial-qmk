...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x7(
        ...
        KC_BTN3,  KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G,                         KC_H, KC_J, KC_K,   KC_L,   KC_SCLN, KC_QUOT,   TO_DVORAK,
    ...
    [_DVORAK] = LAYOUT_5x7(
            KC_ESC,   KC_TILD,  KC_7, KC_5, KC_3, KC_1, KC_9,                        KC_0, KC_2, KC_4,  KC_6,  KC_8, KC_PERC,   KC_GRV,
            SNIPING,  KC_TAB,KC_SCLN,KC_COMM,KC_DOT,KC_P,KC_Y,                       KC_F, KC_G, KC_C,  KC_R,  KC_L, KC_SLSH,   KC_CIRCUMFLEX,
            KC_BTN3,  KC_CAPS, KC_A, KC_O, KC_E, KC_U, KC_I,                         KC_D, KC_H, KC_T,  KC_N,  KC_S, KC_MINS,   TO_QWERTY,
            KC_BTN1,  KC_LSFT, KC_QUOT, KC_Q, KC_J, KC_K, KC_X,                      KC_B, KC_M, KC_W,  KC_V , KC_Z, KC_BSLS,   KC_BTN1,
            KC_LCTL,  KC_LALT,KC_LGUI,KC_LBRC,KC_RBRC,                                        KC_PLUS, KC_EQL, KC_RGUI, KC_RALT,  KC_RCTL,
                                                RAISE, KC_SPC,                  LOWER,
                                                KC_TAB, KC_HOME,                KC_ENT,
                                                KC_BSPC, KC_GRV,       KC_MUTE, KC_LALT
